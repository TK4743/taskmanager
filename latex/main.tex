...
\begin{frame}[t,plain]
  ...
  \vspace*{0.15cm}
  \centerline{\includegraphics[width=10.8cm,height=1.85cm,keepaspectratio]{college_header.png}}
  \vspace{0.08cm}
  ...
  \begin{columns}[c]
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[academiccard,title={Team Member 1}]
        \centering\fontsize{7.8}{9.5}\selectfont
        \textbf{\color{Navy}Tharunkumar K}\\[2pt]
        {\fontsize{6.8}{8.2}\selectfont\color{Charcoal!80}Reg.\;No:\;\textbf{922524205171}}
      \end{tcolorbox}
    \end{column}
    ...
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[academiccard,title={Team Member 2}]
        ...
        {\fontsize{6.8}{8.2}\selectfont\color{Charcoal!80}Reg.\;No:\;\textbf{922524205148}}
      \end{tcolorbox}
    \end{column}
  \end{columns}
...
\begin{frame}[t]{Abstract\enspace---\enspace Problem \& Research Objective}
  ...
  \begin{tcolorbox}[
    ...
    \centering\fontsize{7.0}{8.5}\selectfont
...
\begin{frame}[t]{Literature Survey}
  ...
  \begin{tabular}{|c|>{\raggedright\arraybackslash}p{3.8cm}|>{\raggedright\arraybackslash}p{2.3cm}|c|>{\raggedright\arraybackslash}p{4.7cm}|}
    \hline
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.485\textwidth}
      \begin{tcolorbox}[modcard,title={1.\;Collaborative Learning Module}]
        ...
        \begin{itemize}\setlength{\itemsep}{0pt}
          \item Peer study circles with role-based pair programming.
          \item Synchronous audio/video and cursor broadcasting.
        \end{itemize}
      ...
      \begin{tcolorbox}[modcard,title={2.\;Live Coding Module}]
        \fontsize{6.0}{7.0}\selectfont
        \begin{itemize}\setlength{\itemsep}{0pt}
          \item Operational transformation multi-user code editor.
          \item Sandboxed in-browser code execution engine.
        \end{itemize}
      \end{tcolorbox}\vspace{0.03cm}
      ...
      \begin{tcolorbox}[modcard,title={3.\;Continuous Assessment Module}]
        \fontsize{6.0}{7.0}\selectfont
        \begin{itemize}\setlength{\itemsep}{0pt}
          \item Automated micro-challenges and code tracing.
          \item Immediate test suite verification with edge cases.
        \end{itemize}
      \end{tcolorbox}\vspace{0.03cm}
      ...
      \begin{tcolorbox}[modcard,title={4.\;Evidence Collection Module}]
        \fontsize{6.0}{7.0}\selectfont
        \begin{itemize}\setlength{\itemsep}{0pt}
          \item GitHub commits, LeetCode, and IDE telemetry ingestion.
          \item Centralized log and compile activity normalization.
        \end{itemize}
      \end{tcolorbox}
    \end{column}
    ...
    \begin{column}{0.485\textwidth}
      \begin{tcolorbox}[modcard,title={5.\;Competency Analysis Module}]
        \fontsize{6.0}{7.0}\selectfont
        \begin{itemize}\setlength{\itemsep}{0pt}
          \item Dynamic skill vector estimation across competencies.
          \item Alignment with IEEE/ACM CS Curricula 2023 rubrics.
        \end{itemize}
      \end{tcolorbox}\vspace{0.03cm}
      ...
      \begin{tcolorbox}[modcard,title={6.\;Learning Intervention Module}]
        \fontsize{6.0}{7.0}\selectfont
        \begin{itemize}\setlength{\itemsep}{0pt}
          \item Algorithmic peer-matching for skill balance.
          \item Automated targeted problem set dispatch.
        \end{itemize}
      \end{tcolorbox}\vspace{0.03cm}
      ...
      \begin{tcolorbox}[modcard,title={7.\;Reassessment \& Analytics Module}]
        \fontsize{6.0}{7.0}\selectfont
        \begin{itemize}\setlength{\itemsep}{0pt}
          \item Isomorphic post-evaluations measuring gain ($g$).
          \item Longitudinal cohort mastery statistical dashboards.
        \end{itemize}
      \end{tcolorbox}\vspace{0.03cm}
      ...
      \begin{tcolorbox}[
        ...
        Synchronized closed-loop driving verified competency growth.
      \end{tcolorbox}
    \end{column}
  \end{columns}
\end{frame}
